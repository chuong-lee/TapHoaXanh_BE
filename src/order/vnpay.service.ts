...
//   private readonly VNPAY_RETURN_URL =
//     process.env.VNPAY_RETURN_URL || 'http://localhost:3000/order/payment/vnpay/return';
...
//       const vnp_SecureHash = crypto.createHmac('sha512', this.VNPAY_HASH_SECRET).update(hashData).digest('hex');
...
//     const checkSum = crypto.createHmac('sha512', this.VNPAY_HASH_SECRET).update(hashData).digest('hex');
